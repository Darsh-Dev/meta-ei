...
# with chmod 755.
#
# This script turn on zigbee light.
...
echo "Turn On Zigbee Device..."
echo

mosquitto_pub -m '{"commands":[{"command": "zcl on-off on", "postDelayMs":0},{"command": "plugin device-table send {'"$DEVICE_EUI64"'} 1", "postDelayMs":0 }] }' -t gw/$EUI64/commands
